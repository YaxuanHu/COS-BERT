...
def read_csv(args, data_length=None):
    """
...
# def prefilter_succ_or_fail(args):
#     """preprocess the data prefilter predict succ or fail"""
#     data = read_csv(args)
#     heads_prefilter_succ = []
#     tails_prefilter_succ = []
#     for i in range(len(data)):
#         head_groud_truth = data["heads"][0]
#         head_candidates = data["heads"][3:-1]
#         tail_groud_truth = data["tails"][2]
#         tail_candidates = data["tails"][3:-1]
#         if head_groud_truth in head_candidates:
#             head_groud_truth_index = head_candidates.index(head_groud_truth)
#             heads_prefilter_succ.append(swapPositions(data["heads"][i], 3, head_groud_truth_index+3))
#         if tail_groud_truth in tail_candidates:
#             tail_groud_truth_index = tail_candidates.index(tail_groud_truth)
#             tails_prefilter_succ.append(swapPositions(data["tails"][i], 3, tail_groud_truth_index+3))
#     return{
#         "data_length": data_length,
#         "heads_prefilter_succ": heads_prefilter_succ,
#         "tails_prefilter_succ": tails_prefilter_succ
#     }
